    ...
    return (
        <>
            <nav ref = {pageReference} className="NAVBAR flex flex-row justify-between items-center bg-gray-900 text-white h-24 border-b border-gray-200 dark:border-gray-600">
                ...
                { isMenuOpen && (
                    <div className="MENU-ITEMS top-20 w-5/6 fixed md:top-auto md:static justify-between items-center md:flex md:w-auto md:order-1" id='menu-items'>
                        ...
                        <li>
                            <Link to='/services' class="block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Services</Link>
                        </li>
                        <li>
